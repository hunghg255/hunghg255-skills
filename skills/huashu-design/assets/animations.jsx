 ...
 * - Stage: Entire animation container, provides time + controls
 ...
 *   </Stage>
 *
 * Use useSprite() inside Sprite child components to read current segment progress.
 */
...
(function() {
  ...
  const Easing = {
    ...
    // Fast start + slow deceleration, gives digital elements physical weight
    expoOut: t => t === 1 ? 1 : 1 - Math.pow(2, -10 * t),
    // overshoot: Bouncy toggle/button pop-out (cubic-bezier(0.34, 1.56, 0.64, 1))
    overshoot: t => {
