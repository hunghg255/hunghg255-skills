/**
 * <deck-stage> — HTML slideshow wrapper web component
 *
 * Features provided:
...
(function() {
  ...
  class DeckStage extends HTMLElement {
    ...
    connectedCallback() {
      ...
      // Shadow DOM renders first (independent of child nodes, unaffected by parser timing)
      this._render();

      // Defensive: if script is placed in <head> (instead of after </deck-stage>),
      // the parser may not have finished processing child <section> elements yet, querySelectorAll will return empty.
      ...
      if (this.ownerDocument.readyState === 'loading') {
        ...
        // Document parsing complete (script at bottom of body or defer), collect in next frame
