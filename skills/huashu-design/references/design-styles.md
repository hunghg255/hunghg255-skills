...
> Each style provides: philosophical core + key characteristics + prompt DNA (to be combined with scenario templates)
...
> Scenario fit: ★★★ = Highly recommended / ★★☆ = Suitable / ★☆☆ = Requires adaptation
> AI generation: ★★★ = Direct output quality excellent / ★★☆ = Needs adjustment / ★☆☆ = Recommend HTML execution
> Best path: AI Generation (direct image output) / HTML (code rendering, precise data) / Hybrid (HTML layout + AI illustrations)

**Core Pattern**: Styles with distinct visual elements (illustrations/particles/generative art) perform well with direct AI output; styles relying on precise typography and data (grids/information architecture/white space) are more controllable with HTML rendering.

---

## I. Information Architecture School (01-04)
> Philosophy: "Data is not decoration, it's building material"
...
**Philosophy**: Make data touchable landscape
**Key Characteristics**:
...
**Philosophy**: Design is not decoration, it's the architecture of content
**Key Characteristics**:
- Extreme clarity of content hierarchy
- System fonts only (optimized for reading)
- Blue hyperlink tradition adherence
...
- Calm professional color scheme (gray, navy blue)
- Designed annotation and citation system
...
### 05. Locomotive - Scroll Narrative Masters
**Philosophy**: Scrolling is not browsing, it's a journey
**Key Characteristics**:
- Silky smooth parallax scrolling
- Cinematic storyboard narrative
- Bold spatial white space
...
- Neon and deep space color scheme
...
### 07. Field.io - Algorithm Aesthetics
**Philosophy**: Code is the designer
**Key Characteristics**:
- Generative art systems
- Dynamic graphics different with each visit
- Intelligent orchestration of abstract geometry
- Balance of technical sense and artistry
...
**Key Characteristics**:
- Single visual metaphor throughout entire design
- Mondrian color scheme of blue/red/yellow + black/white
...
- Monochrome or two-color scheme
- Functionalism first
...
**Key Characteristics**:
- Luxury-level white space (70%+)
- Subtle font weight contrast (200-600)
- Strategic use of single accent color
...
- Integration of handmade and digital
...
**Key Characteristics**:
- Hand-drawn algorithmic graphics
...
**Philosophy**: Beauty of system over beauty of individual
**Key Characteristics**:
...
**Philosophy**: The future is not cold, it's lonely poetry
**Key Characteristics**:
- Cinematic lighting and shadow
- Warm version of cyberpunk (orange/teal, not cold blue)
...
**Key Characteristics**:
- Screen design in sci-fi movies (FUI)
- Holographic projection feel
- Multi-layered data visualization
- Believable futuristic sense
...
> Philosophy: "White space is content"

### 17. Takram - Japanese Speculative Design
**Philosophy**: Technology is medium for thought
**Key Characteristics**:
- Elegance of concept prototypes
- Gentle tech sensibility (rounded corners, soft shadows)
- Charts as art
...
**Philosophy**: Design is not filling, it's emptying
**Key Characteristics**:
- Extreme white space (80%+)
...
**Philosophy**: Physical poetry of information
**Key Characteristics**:
...
**Combination Formula**: `[Style Prompt DNA] + [Scenario Template (see scene-templates.md)] + [Specific Content]`

### Core Principle: Describe Mood Not Layout

Key to AI image generation: Short prompts > Long prompts. Describing 3 sentences of mood and content works better than 30 lines of layout details.
...
| Dictate layout positions ("title centered, image on right") | Reference specific aesthetics ("Pentagram editorial feel") |
| Constrain character poses and expressions | Let AI naturally interpret the style |
| List all visual elements to include | Describe what audience should feel |

### Good / Bad Examples

**Bad — Over-constrained (AI generates empty and flat output):**
```
...
**Good — Mood-driven (Generates diverse and textured output):**
```
...
Choose according to the "Best Path" column in the quick reference:
- **AI Generation**: Styles with clear visual elements (06/07/12/13/14/15/16/20), use Gemini/Midjourney for direct output
- **HTML Rendering**: Styles relying on precise typography (01/03/04/10/11/17/18), code controls data and layout
- **Hybrid**: HTML for skeleton layout + AI generation for illustrations/backgrounds (02/05/08/09/19)

### Quality Control

1. ❌ Don't write "in the style of Pentagram" directly → ✅ Use specific design characteristic descriptions
2. Text often errors in AI generation → Replace text after generation
3. Proportions easily distorted → Explicitly specify aspect ratio
...
**Applicable Scenarios**: All visual design including web/PPT/PDF/infographics/covers/illustrations/App etc.
**Integration with image-to-slides**: PPT scenarios can directly reference styles from this file, executed through image-to-slides skill generation
